...
|-|-|-|-|
| [ABeginners_GetStarted](./ABeginners_GetStarted/) | `Jupyter`  | A sample notebook to get started for the openEO Beginners | Loading collection from a backend; openEO process `load_collection` |
